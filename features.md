...
138. Add test for the UI rendering itself for the complete binary, IE build the linux version, run it, and use screenshots or an alternative. Both for xorg or wayland, ideally with a mock server or alternative 
