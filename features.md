...
180. Write test for the full UI, running with a mock xorg or wayland server, and using automation software (or equivlent) to test the actual button presses the user would do
---
